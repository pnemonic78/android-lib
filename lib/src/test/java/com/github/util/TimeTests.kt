...
class TimeTests {
    ...
    fun sameDay() {
        ...
        assertEquals(2020, cal[Calendar.YEAR].toLong())
        assertEquals(Calendar.JUNE.toLong(), cal[Calendar.MONTH].toLong())
        assertEquals(2, cal[Calendar.DAY_OF_MONTH].toLong())
        assertEquals(19, cal[Calendar.HOUR_OF_DAY].toLong())
        assertEquals(48, cal[Calendar.MINUTE].toLong())
        ...
        assertEquals(Calendar.JUNE.toLong(), cal[Calendar.MONTH].toLong())
        assertEquals(2, cal[Calendar.DAY_OF_MONTH].toLong())
        assertEquals(3, cal[Calendar.HOUR_OF_DAY].toLong())
        assertEquals(0, cal[Calendar.MINUTE].toLong())
        assertEquals(0, cal[Calendar.SECOND].toLong())
        assertEquals(0, cal[Calendar.MILLISECOND].toLong())
        ...
        assertEquals(Calendar.JUNE.toLong(), cal[Calendar.MONTH].toLong())
        assertEquals(2, cal[Calendar.DAY_OF_MONTH].toLong())
        assertEquals(0, cal[Calendar.HOUR_OF_DAY].toLong())
        assertEquals(38, cal[Calendar.MINUTE].toLong())
        val offset3 = (3 * DateUtils.HOUR_IN_MILLIS).toInt()
        assertEquals(10800000, offset3.toLong())
        val offset = timeZone.getOffset(time)
        assertEquals(offset3.toLong(), offset.toLong())
